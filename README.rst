...
and analysis methods. The synthetic data is generated by Monte Carlo random
...
to results from other simulators (e.g., `Camino
...
are provided `here
<https://disimpy.readthedocs.io/en/latest/validation.html>`_.

Contribute
##########

If you want to contribute to the development of Disimpy, please read the
